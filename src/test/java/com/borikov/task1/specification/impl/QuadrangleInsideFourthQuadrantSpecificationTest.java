...
public class QuadrangleInsideFourthQuadrantSpecificationTest {
    QuadrangleSpecification specification;

    @BeforeClass
    public void setUp() {
        specification = new QuadrangleInsideFourthQuadrantSpecification();
    }
